...
namespace NeosProLauncher
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public static string VERSION_PATH
        {
            get
            {
                return Path.Combine("app", "Version");
            }
        }
        ...
        private async Task CheckUpdate()
        {
            ...
            {
                MessageBox.Show("Branch Version cannot detect. exiting...");
                base.Close();
                return;
            }
            else
            {
                ...
                if (version != currentVersion)
                {
                    ...
                    if (!File.Exists("Update.7z"))
                    {
                        MessageBox.Show("Update file doesn't exist or missing. check network connection. exiting...");
                        base.Close();
                    }
                    ...
                    try
                    {
                        ...
                        await Process.Start(new ProcessStartInfo
                        {
                            ...
                            FileName = FileName,
                            Arguments = string.Format("x \"{0}\" -y -o\"{1}\"", "Update.7z", "app")
        ...
        private void LaunchVR_Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            Process.Start(Path.Combine("app", "Neos.exe"), IsPublicBuild ? "" : ("-Pro " + this.LicenseParameter + " " + this.ExtraParams));
            base.Close();
        }
        ...
        private void LaunchScreen_Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            Process.Start(Path.Combine("app", "Neos.exe"), IsPublicBuild ? "-Screen" : ("-Pro " + this.LicenseParameter + " -Screen " + this.ExtraParams));
            base.Close();
        }
